...
def simple_replay_train(mainDQN, targetDQN, train_batch):
    ...
    return mainDQN.update(x_stack=x_stack, y_stack=y_stack)
        ...
        for episode in range(max_episode):
            ...
            if episode%10 == 1:
                ...
                for _ in range(50):
                    ...
                    loss, _ = simple_replay_train(mainDQN=mainDQN, targetDQN=targetDQN, train_batch=minibatch)
                print("Loss: {}".format(loss))

                #copy mainDQN -> targetDQN
                sess.run(copy_ops)
